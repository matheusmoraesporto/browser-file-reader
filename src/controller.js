export default class Controller {
    ...
    #events = {
        ...
        ocurrenceUpdate: ({ found, linesLenght, took }) => {
            const [[key, value]] = Object.entries(found)
            this.#view.updateDebugLog(
                `found ${value} ocurrencies of ${key} - over ${linesLenght} lines -
                took: ${took}`
            )
        }
    }
    ...
    init() {
        // on view configureOnFileChange, we'll call this #configureOnFileChange and use bind if it need to use this context
